...
<%@ attribute name="outSidePath" type="java.lang.Boolean" required="false" description="是否外部路径"%>
<%--
...
<script type="text/javascript">
    function ${path}FileDialogOpen() {
        ...
        jp.open({
            ...
            title:"上传文件",
            auto:true,
            content: "${ctx}/tag/fileUpload?fileValues="+encodeURIComponent(currentFileValues)+"&uploadPath=${uploadPath}"+"&type=${type}"+"&readonly=${readonly}"+"&outSidePath=${outSidePath}"
