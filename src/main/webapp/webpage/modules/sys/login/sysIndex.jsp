...
<body class="">
	<nav class="navbar topnav-navbar navbar-fixed-top" role="navigation">
		<div class="navbar-header text-center">
			...
			<a class="navbar-brand J_menuItem"  href="${ctx}/home">天天安途后台管理平台</a>
		</div>
...
<section id="body-container" class="animation">
		...
		<div class="main-container" id="main-container">
			...
			<div class="J_mainContent"  id="content-main" style="${cookie.tab.value!=false?'height:calc(100% - 40px)':'height:calc(100%)'}">
             <iframe class="J_iframe" name="iframe0" width="100%" height="100%" src="${ctx}/article/tArticle" frameborder="0" data-id="${ctx}/article/tArticle" seamless></iframe>
            </div>
            </div>
           ...
           <div class="footer">
			   <div class="pull-left">Copyright  2018 - 2023 天天安途（江苏）信息技术有限公司 All Rights Reserved.</div>
            </div>
