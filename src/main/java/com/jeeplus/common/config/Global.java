...
public class Global {
	...
	public static String getShareBaseDir(){
		String dir =  Global.getUserfilesBaseDir() + Global.USERFILES_BASE_URL  + "sharedocuments/";
	...
	public static String getShareBaseUrl(){
		...
		return  Servlets.getRequest().getContextPath() + Global.USERFILES_BASE_URL +  "/sharedocuments/";
	}
	...
	public static String getMyDocDir(){
		SystemAuthorizingRealm.Principal principal = (SystemAuthorizingRealm.Principal) UserUtils.getPrincipal();
		String dir = Global.getUserfilesBaseDir() + Global.USERFILES_BASE_URL + principal + "/mydocument/";
		FileUtils.createDirectory(dir);
		return dir;
	}
	/**
	...
	public static String getMyDocUrl(){
		SystemAuthorizingRealm.Principal principal = (SystemAuthorizingRealm.Principal) UserUtils.getPrincipal();
		return  Servlets.getRequest().getContextPath() + Global.USERFILES_BASE_URL + principal + "/mydocument/";
	}
	...
	public static String getAttachmentDir(){
		SystemAuthorizingRealm.Principal principal = (SystemAuthorizingRealm.Principal) UserUtils.getPrincipal();
		String dir = Global.getUserfilesBaseDir() + Global.USERFILES_BASE_URL + principal + "/attachment/";
		FileUtils.createDirectory(dir);
		return dir;
	}
	...
	public static String getAttachmentUrl(){
		...
		SystemAuthorizingRealm.Principal principal = (SystemAuthorizingRealm.Principal) UserUtils.getPrincipal();
		return  Servlets.getRequest().getContextPath() + Global.USERFILES_BASE_URL + principal + "/attachment/";
	}
	 ...
	 * @return
	 */
	public static String getOutSidePathDir(){
		SystemAuthorizingRealm.Principal principal = (SystemAuthorizingRealm.Principal) UserUtils.getPrincipal();
		String basedir = Global.getConfig("pro.images.basedir");
		String dir = basedir + "/" + principal;
		FileUtils.createDirectory(dir);
		return dir;
	}

	/**
	 * 图片外部路径 网络访问地址  ffy add
	 * @return
	 */
	public static String getOutSidePathUrl(){
